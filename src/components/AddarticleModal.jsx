      ...
      <div className="mx-auto max-w-4xl px-6 py-8 ">
        ...
        <div className="space-y-6 rounded-xl  p-6 ">
          ...
          <div className="flex justify-end gap-3 pt-4 ">
            <button className="rounded-lg cursor-pointer border px-4 py-2 text-sm hover:bg-gray-100">
              Cancel
            </button>
            <button className="rounded-lg cursor-pointer bg-gray-900 px-4 py-2 text-sm text-white hover:bg-gray-800">
              Publish
            </button>
          </div>
        </div>
